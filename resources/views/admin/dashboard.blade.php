                        ...
                        <table class="table table-hover table-centered align-middle table-nowrap mb-0">
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-sm bg-light rounded p-1 me-2">
                                            <img src="{{asset('theme/admin/assets/images/products/img-1.pn')}}g" alt="" class="img-fluid d-block" />
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-sm bg-light rounded p-1 me-2">
                                            <img src="{{asset('theme/admin/assets/images/products/img-2.pn')}}g" alt="" class="img-fluid d-block" />
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-sm bg-light rounded p-1 me-2">
                                            <img src="{{asset('theme/admin/assets/images/products/img-3.pn')}}g" alt="" class="img-fluid d-block" />
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-sm bg-light rounded p-1 me-2">
                                            <img src="{{asset('theme/admin/assets/images/products/img-4.pn')}}g" alt="" class="img-fluid d-block" />
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-sm bg-light rounded p-1 me-2">
                                            <img src="{{asset('theme/admin/assets/images/products/img-5.pn')}}g" alt="" class="img-fluid d-block" />
                                        </div>
                                        <div>
                        ...
                        <table class="table table-centered table-hover align-middle table-nowrap mb-0">
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-2">
                                            <img src="{{asset('theme/admin/assets/images/companies/img-1.p')}}ng" alt="" class="avatar-sm p-2" />
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-2">
                                            <img src="{{asset('theme/admin/assets/images/companies/img-2.p')}}ng" alt="" class="avatar-sm p-2" />
                                        </div>
                                        <div class="flex-grow-1">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-2">
                                            <img src="{{asset('theme/admin/assets/images/companies/img-3.p')}}ng" alt="" class="avatar-sm p-2" />
                                        </div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-2">
                                            <img src="{{asset('theme/admin/assets/images/companies/img-8.p')}}ng" alt="" class="avatar-sm p-2" />
                                        </div>
                                        <div class="flex-grow-1">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-2">
                                            <img src="{{asset('theme/admin/assets/images/companies/img-5.p')}}ng" alt="" class="avatar-sm p-2" />
                                        </div>
                                        <div class="flex-grow-1">
                                            <h5 class="fs-14 my-1 fw-medium">
                        ...
                        <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-2">
                                            <img src="{{asset('theme/admin/assets/images/users/avatar-1.jp')}}g" alt="" class="avatar-xs rounded-circle" />
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-2">
                                            <img src="{{asset('theme/admin/assets/images/users/avatar-2.jp')}}g" alt="" class="avatar-xs rounded-circle" />
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-2">
                                            <img src="{{asset('theme/admin/assets/images/users/avatar-3.jp')}}g" alt="" class="avatar-xs rounded-circle" />
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-2">
                                            <img src="{{asset('theme/admin/assets/images/users/avatar-4.jp')}}g" alt="" class="avatar-xs rounded-circle" />
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-2">
                                            <img src="{{asset('theme/admin/assets/images/users/avatar-6.jp')}}g" alt="" class="avatar-xs rounded-circle" />
                                        </div>
